...
/**
 * Conversion of standard and custom bases using a constrained single-byte alphabet (0x04–0xFF)
 */
abstract class BaseConvert {
     ...
     * Changing via fluent interface method setEndianChunkMode()
    */
     ...
     * byte values greater than 127 (0x80–0xFF). These values are not standalone UTF-8 bytes 
     * and will be displayd incorrectly as replacement characters (e.g. �)
     *
     * Used for:
     * - Encode
     * - Decode
     ...
     *
     * Output is returned as raw bytes (one byte per symbol), not as UTF-8 text
     * When interpreted as text, bytes above 127 may display incorrectly (e.g. �)
     ...
     * (chr(128) to chr(255))
     *
     * Input should be uniform and generated by
     * precompute256Precompute100(), unless decoded is shorter than 169 bytes
     *
     * The uniform format ensures deterministic and reliable output
     *
     * Used for:
     * - Decode
     */
     ...
     * Meaning, 406 digits is the maximum length for a uniform random digitnumber
     *
     * The uniform format ensures deterministic and reliable output
     * 
     * Used for:
    ...
    /**
     * Conversion from non-power-of-2 bases (e.g. base5, base58, base62) to base100
     * 
     * Used for:
     * - Decode
     */
    ...
    /**
     * Conversion from non-power-of-2 bases (e.g. base5, base58, base62) to base10
     * 
     * Use Transcode::getISO(x) when the input contains single-byte characters with 
     * byte values higher than 127 (chr(128) to chr(255))
     * 
     * Used for:
     * - Decode
     */
    ...
    /**
     * Conversion from base10 to non-power-of-2 bases (e.g. base5, base58, base62)
     * 
     * Used for:
     * - Encode
     */
    ...
    /**
     * Conversion from base256 to non-power-of-2 bases (e.g. base5, base58, base62)
     * 
     * It is not recommended to use Transcode::getISO(x), because base256 is text
     * It will be normalized to a uniform format by precompute256Precompute100() before conversion
     * 
     * Output is returned as text (base256), it is not recommended to use Transcode::getUTF(x) 
    ...
    /**
     * Conversion from non-power-of-2 bases (e.g. base5, base58, base62) to base256
     * 
     * Output is returned as text (base256), it is not recommended to use Transcode::getUTF(x) 
     * for printing the output
     * 
    ...
    /**
     * Conversion from base256 to baseX (X = 4, 8, 16, 32, 64, 128)
     * 
     * Used for:
     * - Encode
     */
    ...
    /**
     * Conversion from baseX (X = 4, 8, 16, 32, 64, 128) to base256
     * 
     * Used for:
     * - Decode
     */
    ...
    /**
     * Conversion from base10 to baseX (X = 4, 8, 16, 32, 64, 128) 
     * 
     * Used for:
     * - Encode
     */
    ...
    /**
     * Conversion from baseX (X = 4, 8, 16, 32, 64, 128) to base10 
     * 
     * Used for:
     * - Decode
     */
    ...
    /**
     * Conversion from baseX (X = 4, 8, 16, 32, 64, 128) to baseY (Y = 4, 8, 16, 32, 64, 128)
     * 
     * Used for:
     * - Encode
     */
    ...
    /**
     * Conversion from non-power-of-2 bases (e.g. base5, base58, base62) to baseX (X = 4, 8, 16, 32, 64, 128)
     * 
     * Used for:
     * - Encode
     */
    ...
    /**
     * Conversion from baseX (X = 4, 8, 16, 32, 64, 128) to non-power-of-2 bases (e.g. base5, base58, base62)
     * 
     * Used for:
     * - Encode
     */
    ...
    /**
     * Conversion from non-power-of-2 bases (e.g. base58, base62) to non-power-of-2 bases (e.g. base5, base109)
     * 
     * Used for:
     * - Encode
     */
    ...
    //Logic-business methods

    /**
     * Conversion from Endian-Chunks (gmp/bc) to text (base256)
     * 
     * Used for:
    ...
    /**
     * Conversion from text (base256) to Endian-Chunks (gmp/bc)
     * 
     * Used for:
    ...
    /**
     * Sets the alphabet for the base conversions
     */
    ...
    /**
     * Can be set to true or false through a fluent interface to control chunk usage.
     * If GMP is disabled, setting this to false may offer slightly better performance,
    ...
    /**
     * Clears all active shuffles and related properties to free up memory when unset is called
     */    
    protected function clearBaseConvert() : void {
        $props = [
