...
/**
 * Conversion of using single-byte alphabet (0x01–0xFF)
 */
abstract class BaseConvert {
    ...
    */
     ...
     *
     * - see src/Core/Documentation/Format/Encoding.md for details about input and output formats
     *
     * Used for:
     * - src/Core/Documentation/Conversion/Encode.md
     * - src/Core/Documentation/Conversion/Decode.md
     */
