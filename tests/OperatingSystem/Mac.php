...
/**
 * Test for iOS on Apple Silicon CPU (new Mac)
 * Note: old Mac with Intel CPU should use iOS_x86_64.php test file
 * Use terminal command: php tests/OperatingSystem/iOS.php
...
if (!class_exists('FFI') || !extension_loaded('ffi')) {
    ...
    if (php_uname('m') === 'arm64') {
        $path = '/src/Core/Component/FFI/Compiled/shuffleindice.dylib';
    } 
    else {
        $path = '/src/Core/Component/FFI/Compiled/shuffleindice_x86_64.dylib';
    }
